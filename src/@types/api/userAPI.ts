...
export type AuthenticateErrorResponseBody = APIError<
  "INVALID_SIGNATURE" | "AUTHENTICATION_FAILURE" | "NOT_FOUND"
>;
...
export type ErrorResponseBody = APIError<
...
export type GetUserStatusResponseBody = {
  isBlocked: boolean;
  trades: number;
...
export type EnableBatchingRequestBody = {
...
export type RedeemReferralCodeResponseBody = APISuccess & {
  bonusPoints: User["bonusPoints"];
};
export type RedeemReferralCodeErrorResponseBody = APIError<
  "ALREADY_TAKEN" | "NOT_ENOUGH_POINTS"
>;

export type RedeemTradesRequestParams = {};
export type RedeemTradesRequestQuery = {};
export type RedeemTradesRequestBody = {};
export type RedeemTradesResponseBody = APISuccess & {
  bonusPoints: User["bonusPoints"];
};
