...
export type AcceptSellOfferTradeRequestByIdsRequestParams = {sellOfferId:string, userId:string};
export type AcceptSellOfferTradeRequestByIdsRequestQuery = {};
export type AcceptSellOfferTradeRequestByIdsRequestBody =   {paymentDataEncrypted:string,
...
export const acceptSellOfferTradeRequestReceivedByIds =
  ...
  async ({sellOfferId,userId,paymentDataEncrypted,paymentDataSignature,paymentData}: Props) => {
