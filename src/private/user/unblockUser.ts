...
type Props = RequestProps & UnblockUserRequestParams & UnblockUserRequestQuery & UnblockUserRequestBody
...
export const unblockUser
  = ({ url }: PeachAPIOptions, helpers: PeachAPIHelpers) =>
    async ({ userId, signal }: Props) => {
      ...
      return  await parseResponse<UnblockUserResponseBody, UnblockUserErrorResponseBody>(response)
    }
