...
type Props = RequestProps & ConfirmPaymentRequestParams & ConfirmPaymentRequestQuery & ConfirmPaymentSellerRequestBody
...
export const confirmPaymentSeller =
  ...
  async ({ contractId, releaseTransaction, batchReleasePsbt, signal }: Props) => {
    ...
    return parseResponse<ConfirmPaymentSellerResponseBody, ConfirmPaymentErrorResponseBody>(response)
  }
