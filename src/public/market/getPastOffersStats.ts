...
export const getPastOffersStats =
  ...
  async ({ signal, meansOfPayment }: RequestProps & GetHistoricalOfferDataRequestBody = {}) => {
    ...
    return parseResponse<GetHistoricalOfferDataResponseBody, GetHistoricalOfferDataErrorResponseBody>(response)
  }
